...
def test_check_bucket_region_correct_region(caplog, s3_client_us_west_2, s3_bucket_us_west_2):
    plugin = S3RegionCheckPlugin()
...
def test_check_bucket_region_incorrect_region(caplog, s3_client_us_east_2, s3_bucket_us_west_2):
    plugin = S3RegionCheckPlugin()
